...
def callback(msg):
    ...
    # X, Y, and Z axes in [m/s^2]
    real_topic.linear_acceleration = msg.linear_acceleration
    # Angular rates along x,y,z axes, and status
    # X, Y, and Z axes in [radians/s]
    real_topic.angular_velocity = msg.angular_velocity
